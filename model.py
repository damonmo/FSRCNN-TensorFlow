...
class Model(object):
  ...
  def __init__(self, sess, config):
    ...
    self.padding = 4
    # Different image/label sub-sizes for different scaling factors x1, x2, x3, x4
    scale_factors = [[20 + self.padding, 20], [20 + self.padding, 40], [14 + self.padding, 42], [12 + self.padding, 48]]
